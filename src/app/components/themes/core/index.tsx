...
import { ResumePDFPrivacyStatements } from "./ResumePDFPrivacyStatements";
  ...
  return (
    <View style={{ width: "100%" }}>
      {cleaned.map((item, idx) => (
        <View style={{ ...styles.flexRow, flexWrap: "nowrap", width: "100%" }} key={idx}>
          {showBulletPoints && (
            <Text
              style={{
...
export { ResumePDFPrivacyStatements } from "./ResumePDFPrivacyStatements";
