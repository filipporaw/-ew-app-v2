...
import { getPageMarginStyle } from "lib/pdf/page-margins";

const A4_PAGE_MARGINS = getPageMarginStyle("A4");
const {
  paddingTop: a4PaddingTop,
  paddingRight: a4PaddingRight,
  paddingLeft: a4PaddingLeft,
} = A4_PAGE_MARGINS;
...
const elegantStyles = StyleSheet.create({
  ...
  headerBackground: {
    ...
    marginTop: -a4PaddingTop,
    marginLeft: -a4PaddingLeft,
    marginRight: -a4PaddingRight,
    paddingTop: 25,
    paddingBottom: 25,
    paddingLeft: a4PaddingLeft,
    paddingRight: a4PaddingRight,
...
export const CoverLetterModernPDF: React.FC<{ data: CoverLetterData }> = ({ data }) => (
  <Document>
    <Page wrap size="A4" style={modernStyles.page}>
...
export const CoverLetterElegantPDF: React.FC<{ data: CoverLetterData }> = ({ data }) => (
  <Document>
    <Page wrap size="A4" style={elegantStyles.page}>
