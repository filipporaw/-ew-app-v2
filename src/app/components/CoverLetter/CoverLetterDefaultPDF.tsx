...
const createDefaultStyles = (settings: any, pageMarginStyle: ReturnType<typeof getPageMarginStyle>) => {
  ...
  return StyleSheet.create({
    ...
    paragraph: {
      ...
      minHeight: (fontSizeValue - 0.5) * 1.5,
    },
    content: {
      fontSize: fontSizeValue,
      lineHeight: 1.5, // Allineato al render HTML
...
export const CoverLetterDefaultPDF = ({ coverLetter, settings, isPDF }: CoverLetterPDFProps) => {
  ...
  const styles = createDefaultStyles(settings, pageMarginStyle);
