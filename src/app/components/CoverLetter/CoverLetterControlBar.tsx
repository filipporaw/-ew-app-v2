      ...
      <div className="flex items-center flex-shrink-0 ml-4">
        {downloadUrl && !isGenerating ? (
          ...
          >
            ...
            <span className="whitespace-nowrap text-sm font-medium">Download Cover Letter</span>
          </a>
        ) : (
...
/**
 * Load CoverLetterControlBar client side (client-only)
 */
export default CoverLetterControlBar;

export const CoverLetterControlBarBorder = () => (
