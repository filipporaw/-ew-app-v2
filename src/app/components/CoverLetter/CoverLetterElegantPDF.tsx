...
export const CoverLetterElegantPDF = ({ coverLetter, settings }: CoverLetterPDFProps) => {
  ...
  const styles = createElegantStyles(settings, pageMarginStyle);
  ...
  const coverLetterData = {
    ...
    content: {
      greeting: profile.hiringManager || "To the Hiring Manager,",
      body: content && content.length > 0
        ? content.split(/\r?\n\r?\n/)
        : ["I am writing to formally apply for the position at your company."],
      closing: profile.closing || "With Sincerity,"
    },
