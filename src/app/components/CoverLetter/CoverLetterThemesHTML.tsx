...
import { CoverLetterRoverHTML } from './CoverLetterRoverHTML';
import { CoverLetterRoadHTML } from './CoverLetterRoadHTML';
import { CoverLetterElegantHTML } from './CoverLetterElegantHTML';
...
export const CoverLetterModernHTML: React.FC<{ 
  ...
  } else if (coverLetterTheme === "rover") {
    return <CoverLetterRoverHTML data={data} settings={settings} />;
  } else if (coverLetterTheme === "road") {
    return <CoverLetterRoadHTML data={data} settings={settings} />;
  } else if (coverLetterTheme === "elegant") {
    return <CoverLetterElegantHTML data={data} settings={settings} />;
  } else {
