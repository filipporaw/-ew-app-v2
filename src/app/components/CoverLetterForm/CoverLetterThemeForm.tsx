...
export const CoverLetterThemeForm = () => {
          ...
          <div className="mt-2 flex flex-wrap gap-3">
            {["default", "minimal", "rover", "road", "elegant"].map((type, idx) => {
              return (
                <div
                  key={idx}
                  className="flex w-[105px] cursor-pointer items-center justify-center rounded-none border border-gray-300 py-1.5 shadow-none hover:border-gray-400 hover:bg-100 text-center"
