...
import { initialCoverLetterState } from "lib/redux/coverLetterSlice";
...
export const ResumeDropzone = ({
  ...
  const onImportClick = async () => {
    ...
    if (file.name.endsWith(".json")) {
        ...
        // Prefer importing settings when present in metadata/attachment.
        settings = parseResult.settings ? deepClone(parseResult.settings) : deepClone(initialSettings);
    }
